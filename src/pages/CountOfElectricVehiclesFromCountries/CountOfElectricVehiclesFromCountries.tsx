...
import useCountOfElectricVehiclesFromCountries from "@/services/api/countOfElectricVehiclesFromCountries";

import DataView from "./DataView";
import GraphView from "./GraphView";

function CountOfElectricVehiclesFromCountries() {
    const { data, isFetching, refetch } =
        useCountOfElectricVehiclesFromCountries();
    ...
    return (
        <>
            <Heading>
                <span>
                    Vypísanie krajín a počtu áut poháňaných na elektrinu
                </span>
